...
<head>
    ...
    <meta property="og:image" content="../../files/card_for_messengers.jpg">
    ...
    <meta name="twitter:image" content="../../files/card_for_messengers.jpg">

    <!-- NOTE: Icon for iOS -->
    <link rel="apple-touch-icon" sizes="512x512" href="../../files/apple-touch-icon.png">

    <link rel="icon" href="../../files/favicon.ico">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@100..900&display=swap" rel="stylesheet">

    <?php if (!isset($noStyle) || !$noStyle): ?>
        <link rel="stylesheet" href="../../public/style.css?v=<?php echo $version; ?>">
    <?php endif; ?>
